...
correo = official[0][0] == String(contact[0]) ? 'https://www.tiktok.com/@russellpaypal' : official[1][0] == String(contact[0]) ? 'https://www.tiktok.com/@russellpaypal' : official[2][0] == String(contact[0]) ? 'https://www.tiktok.com/@russellpaypal' : mail === '' ? lenguajeGB.smsContacto6() : mail
lugar = official[0][0] == String(contact[0]) ? 'CortanaBot' : official[1][0] == String(contact[0]) ? 'CortanaBot' : official[2][0] == String(contact[0]) ? 'CortanaBot' : official[3][0] == String(contact[0]) ? 'CortanaBot' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'https://www.tiktok.com/@russellpaypal' : official[1][0] == String(contact[0]) ? 'https://www.tiktok.com/@russellpaypal' : official[2][0] == String(contact[0]) ? 'https://www.tiktok.com/@russellpaypal' : official[3][0] == String(contact[0]) ? 'https://www.tiktok.com/@russellpaypal' : md 
